...
//                 for i in 0..initial_window.len() / 2 {
...
//                 }
//                 while !self.small_half.is_empty()
//                     && self
//                         .removed_elements
//                         .contains_key(self.small_half.peek().unwrap())
//                 {
//                     let top = self.small_half.pop().unwrap();
//                     let count = self.removed_elements.get(&top).unwrap();
//                     if *count > 1 {
//                         *self.removed_elements.get_mut(&top).unwrap() -= 1;
//                     } else {
//                         self.removed_elements.remove(&top);
//                     }
//                 }
//                 while !self.large_half.is_empty()
//                     && self
//                         .removed_elements
//                         .contains_key(&self.large_half.peek().unwrap().0)
//                 {
...
//                 }
//             }
//             fn push(&mut self, new: i32) {
//                 self.small_half.push(new);
//                 self.large_half
...
//         // Let's go!
//         for i in k as usize..nums.len() {
//             let to_remove = nums[i - k as usize];
//             let to_insert = nums[i];
//         }
// 
//         vec![0.0]
//     }
